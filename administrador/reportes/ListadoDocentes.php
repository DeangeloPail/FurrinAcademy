...
function Header()
{
 ...
 //Impresion
    $this->SetFont('Arial','B',10);
    $this->Cell(60, 10, 'Nombre del Docente', 1, 0, 'C', 0);
    $this->Cell(60, 10, 'Direccion', 1, 0, 'C', 0);
    $this->Cell(60, 10, 'Usuario', 1, 1, 'C', 0);
...
while($row = $resultado->fetch_assoc()){
    $pdf->Cell(60, 10, $row['Nombre_profe'], 1, 0, 'C', 0);
    $pdf->Cell(60, 10, $row['Direccion'], 1, 0, 'C', 0);
    $pdf->Cell(60, 10, $row['codigo_usuarioo'], 1, 1, 'C', 0);
