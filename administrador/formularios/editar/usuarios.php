...
include('../../sql/vistas/tipo_usuarios.php');
  ...
  $IdUsuario=$filaUsuario["codigo_usuario"];
...
?>
<form id="formulario" action="../../sql/modificar/usuarios.php" method="POST" enctype="multipart/form-data" class="row  mx-3 g-3 needs-validation" novalidate >
  <div class = "form-group">
      <input type="hidden"  readonly class="form-control"  
            name="UsuarioID" required="" id="UsuarioID" value="<?php echo $IdUsuario;?>" placeholder="ID">
  </div>
        
  <div class = "form-group">
      <label for="usuario">Nombre de Usuario:</label>
      <input type="text" class="form-control mt-3" 
             name="usuario" required="" id="usuario" value="<?php echo $NombreUsuario;?>"  placeholder="Nombre de Usuario">
  ...
  <div class = "form-group">
      ...
      <input type="password" class="form-control mt-3" 
             name="constrasena" required="" id="constrasena" value="<?php echo $Contrasena;?>"  placeholder="Constrasena">
