...
include('../../sql/vistas/usuarios_p.php');
  ...
  $resultadoEstudiantes=mysqli_query($conexion,$sql);

  $filaEstudiantes=mysqli_fetch_assoc($resultadoEstudiantes);
  $codigo=$filaEstudiantes["Codigo_estudiante"];
  $nombre=$filaEstudiantes["Nombre_estudiante"];
  $apellido=$filaEstudiantes["Apellido_estudiante"];
  $direccion=$filaEstudiantes["Direccion"];
  $telefono=$filaEstudiantes["Telefono"];
?>
<form id="formulario" action="../../sql/modificar/estudiantes.php" method="POST" enctype="multipart/form-data" class="row  mx-3 g-3 needs-validation" novalidate >
    
    <div class = "form-group">
        <input type="hidden" class="form-control mt-3" 
        name="CodigoEstudia" value="<?php echo $codigo ;?>" id="CodigoEstudia"  placeholder="Codigo">
    ...
    <div class = "form-group">
        ...
        name="NombreEstudia" value="<?php echo $nombre ;?>" id="NombreEstudia"  placeholder="Nombres">
    ...
    <div class = "form-group">
        ...
        <input type="text" class="form-control mt-3" 
        name="ApellidoEstudia" value="<?php echo $apellido ;?>" id="ApellidoEstudia"  placeholder="Apellidos">
    ...
    <div class = "form-group">
        ...
        <input type="text" class="form-control mt-3" 
        name="Direccion" value="<?php echo $direccion ;?>" id="Direccion"  placeholder="Dirección">
    ...
    <div class = "form-group">
        ...
        <input type="text" class="form-control mt-3" 
        name="Telefono" value="<?php echo $telefono ;?>" id="Telefono"  placeholder="Teléfono">
