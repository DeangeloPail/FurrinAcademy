...
?>
<form id="formulario" action="../../sql/agregar/contenidos.php" method="POST" enctype="multipart/form-data" class="row  mx-3 g-3 needs-validation" novalidate >
...
<script src="../../js/contenido_agregar.js"></script>
